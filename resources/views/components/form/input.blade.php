...
<x-form.field>
    ...
    <div
        class="flex justify-between items-center {{ $errors->has($name) ? 'border-red' : (old($name) ? 'border-bggreen' : 'border-light-gray') }} focus-within:shadow-custom focus-within:border-bl lg:h-56 py-18 pl-24 rounded-lg border-2">
