<x-dashboardLayout>
    <div class="ml-16 mt-24 lg:mr-108 lg:ml-108 mb-56">
        @include('_navigate')
        <div class="lg:mt-40 flex flex-col gap-2 mr-16 xl:flex-row xl:gap-6 xl:justify-between">
            <div class="flex xl:hidden">
                <div class="xl:flex-1 xl:w-392 xl:h-255 min-w-343 relative h-193 flex justify-center items-center ">
            ...
            <div
                class="hidden xl:flex-1 xl:w-392 xl:h-255 min-w-343 relative h-193 xl:flex justify-center items-center ">
                <div class="absolute inset-0 bg-purple opacity-5 rounded-2xl"></div>
                <div class="flex flex-col justify-center items-center">
                    <img class="w-90 h-50" src={{ asset('images/Group-1797.png') }} />
                    <p class="text-dark-black text-base font-medium mt-16 mb-16">{{ __('dashboard.new_cases') }}</p>
            ...
            <div
                class="hidden xl:flex-1 xl:w-392 xl:h-255 min-w-164 relative h-193 xl:flex justify-center items-center ">
            ...
            <div class="xl:flex-1 gap-4 flex xl:gap-6 xl:hidden">
                <div class="xl:flex-1 xl:w-392 xl:h-255 min-w-164 relative h-193 flex justify-center items-center ">
                    <div class="absolute inset-0 bg-bggreen opacity-5 rounded-2xl"></div>
                    <div class="flex flex-col justify-center items-center">
                        <img class="w-90 h-50" src={{ asset('images/Group-1700.png') }} />
                        <p class="text-dark-black text-base font-medium mt-16 mb-16">{{ __('dashboard.recovered') }}
